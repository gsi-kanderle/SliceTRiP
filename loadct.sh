...
str="$*"
additionalModule1="/u/motion/Software/Slicer/Modules/SliceTRiP/LoadCTXLight"
additionalModule2="/u/kanderle/Software/Slicer/SliceTRiP/TRiPDVH"
...
/u/motion/Software/Slicer/Slicer-Stable/Slicer --no-main-window --additional-module-path ${additionalModule1} \
--modules-to-ignore ${modulesToIgnore} \
--python-script /u/motion/Software/Slicer/Modules/SliceTRiP/Slicet/LoadCTXSlicet.py -- ${str}
