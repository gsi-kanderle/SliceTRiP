...
class LoadCTXWidget:
  ...
  def onLoadButton(self): 
	...
	#optDose = 25
	self.dos = logic.loadCube(filePath,fileInfo,optDose = optDoseValue)
  ...
  def onSetOriginButton(self):
    ...
    #gridTransform1 = vtk.vtkGridTransform()
    ...
    #slicerTransform.SetAndObserveTransformFromParent(gridTransform2)
    
    #vectorNode.GetIJKToRASDirectionMatrix(matrix)
    #slicerTransform.ApplyTransformMatrix(matrix)
    ##slicerTransform.SetAndObserveTransformToWorld(matrix)
